    ...
    return (
        <div className="col-md-12">
          <form className="searchForm" onSubmit={(event) => this.handleSubmit(event)}>
            ...
            <input type="number" name="input-year" value={this.state.year} onChange={(event) => this.handleYearChange(event)} />
            <Select value={this.state.month} onChange={this.handleMonthSelected} options={this.props.months}/>
